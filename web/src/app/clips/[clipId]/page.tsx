  ...
  return (
    <main className="min-h-screen gradient-bg flex items-center justify-center px-6 py-16">
      <div className="max-w-xl w-full text-center space-y-10">
        <div className="inline-flex items-center gap-2 rounded-full border border-border/50 bg-card/60 px-4 py-1.5 text-xs text-muted-foreground backdrop-blur">
          <Sparkles className="h-3.5 w-3.5 text-brand" />
          ClipForge · AI viral clip studio
        </div>

        <div className="space-y-4">
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-card/60 border border-border/40">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-brand px-6 py-3 text-sm font-semibold text-white hover:bg-brand-glow transition"
          >
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 rounded-full border border-border/60 bg-card/40 px-6 py-3 text-sm font-medium text-muted-foreground hover:text-foreground transition"
          >
